...
from service.langchain.embedding_langchain import embedding
from service.langchain.generating_langchain import make_generate
from service.langchain.retrieving_langchain import make_retrieve
...
# Embed and upload to MongoDB Atlas
    ...
    result = make_retrieve(vectorstore_db)
    state["context"] = result["context"]

    # Generate answer
    answer_result = make_generate(llm)
